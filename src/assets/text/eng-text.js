export default {
  ...
  services: {
    ...
    cardDeveloperSkillsText: {
      ...
      content:
        "На текущий момент, я разрабатываю web-интерфейсы для управления устройствами пожарной безопасности. Также работал над созданием различных автоматизированных информационных систем.",
    },
    cardFrontendText: {
      title: "Frontend",
      content:
